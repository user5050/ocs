...
namespace OneCoin.Service.Helper.Http
{
    public class HttpClient
    {
        ...
        public static bool NODescryptInputStream = false; 
        #endregion
        ...
        private HttpWebRequest CreateRequest()
        {
            ...
            if (NODescryptInputStream)
            {
                req.Headers.Add("NODescryptInputStream", "true");
            }
            ...
            if (postingData.Count > 0 || files.Count > 0 || !string.IsNullOrEmpty(PostString))
                verb = HttpVerb.POST;
            ...
            if (verb == HttpVerb.POST)
            {
                ...
                else
                {
                    ...
                    {
                        if (key.Length <= 0)
                            sb.AppendFormat("{0}&", postingData[key]);
                        else
        ...
        public HttpWebResponse GetResponse()
        {
            ...
            //检查是否含有认证信息
            //bool containsUserIndentity = false;
            //for (int i = 0; i < res.Cookies.Count; i++)
            //{
            //    System.Net.Cookie curCookie = res.Cookies[i];
            //    if (curCookie.Name == "_user")
            //    {
            //        containsUserIndentity = true;
            //    }
            //}


            //if (keepContext && containsUserIndentity)
            //{
