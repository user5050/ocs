...
namespace Kulv.YCF.Payment.Wing.H5ForM
{
    class AsnKeyParser
    {
        ...
        private static readonly String ENV_URL = "https://capi.bestpay.com.cn"; // 生产地址
        ...
        internal AsnKeyParser(String pathname)
        {
            ...
            //string publickey = GetPublicKey().PubKey;

            parser = new AsnParser(Convert.FromBase64String(pathname));

        }

        private RsaKeyBO GetPublicKey()
        {
